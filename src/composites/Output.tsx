...
const Output: React.FC<OutputProps> = ({ isLoading, error, outputData }) => {
  if (!outputData) {
    return (
      <div className="p-4 text-center">
        <p>This is where the output will be shown, try filling the input form and clicking the predict button.</p>
      </div>
    );
  }
  ...
  if (outputKey === 'Generated Image') {
    return (
      <div className="output-section">
        <img src={outputValue} alt="Generated output" className="rounded-lg w-80" />
      </div>
    );
  }
